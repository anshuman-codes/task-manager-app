  ...
  return (
    <div className="stage-area flex-box">
      ...
      {isMobileView && showSidebar ? (
        ...
        <main className="your-profile-section flex-box">
          <h1 className="text-center">Your Profile</h1>
          <form className="your-profile-box text-center">
            <div className="your-profile-avatar">
              <img src={avatar} alt="Profile" />
            </div>

            <div className="your-profile-data">
              <div className="your-avatar-row text-center">
