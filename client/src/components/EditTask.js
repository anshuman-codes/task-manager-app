...
const EditTask = () => {
  ...
  const getData = async () => {
    ...
    setTaskMessage(data.description);
    setIsLoading(false);
  };
    ...
    <div className="stage-area flex-box">
      ...
      {isMobileView && showSidebar ? (
        ...
        <div className="create-task-bar">
          <h1 className="viewTasks-title"> Edit Your Task</h1>
          <p className="create-task-decscrip">
            Please enter the following Changes that you want in your task. After
            making the changes, click on "Save Changes"
          </p>
          <form className="create-task-form" onSubmit={handleSubmit}>
            ...
            />
            {showEditingTask && (
              <p className="show-created-message text-center">Task Edited</p>
            )}
